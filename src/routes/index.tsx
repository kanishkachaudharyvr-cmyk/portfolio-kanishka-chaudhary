...
const SKILLS = {
  ...
  "AI & Tools": ["Gemini", "Claude", "Copilot", "Cursor AI", "PyTorch", "OpenCV", "Google AI Studio"],
  "Core CS": ["Data Structures", "Algorithms", "Computer Networks", "Operating Systems", "DBMS (MySQL)", "Theory of Computation"],
  "Design": ["Photography", "Digital Creatives", "Brand Systems", "Writing"],
};
...
const EXPERIENCE = [
  {
    ...
    color: "terracotta",
    body: "Selected for the 2026 cohort to advocate Google AI technologies, hosting hands-on workshops and shipping AI solutions with the Agent Development Kit.",
  },
  {
    ...
    period: "Jan — Feb 2026",
    color: "sage",
    body: "Built full-stack web applications with clean frontend experiences and streamlined backend logic — including a Razorpay clone and a Spotify song downloader.",
  },
  {
    ...
    period: "Sep — Oct 2025",
    color: "ochre",
    body: "Designed digital creatives and campaign material that lifted social engagement while staying true to brand identity.",
  },
  {
    role: "Core Member — Marketing & Digital Creative",
    org: "ABIT, RGIT",
    period: "Sep 2024 — Present",
    body: "Plan campus-wide promotional models and craft the visual branding architecture that carries the IT department's technical presence.",
  },
];
